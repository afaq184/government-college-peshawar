/**
 * Phase 5 (evening-students/fifth_phase_eveing): CS, Pre-Engineering, Pre-Medical.
...
const PHASE5 = 'public/student/evening-students/fifth_phase_eveing';
...
const SOURCES = [
  {
    excel: `${PHASE5}/Medical.xlsx`,
    photoDir: `${PHASE5}/Medical pic`,
    photoPrefix: 'evening-students/fifth_phase_eveing/Medical pic',
    className: 'Pre-Medical',
  },
  {
    excel: `${PHASE5}/engineering.xlsx`,
    photoDir: `${PHASE5}/engineering`,
    photoPrefix: 'evening-students/fifth_phase_eveing/engineering',
    className: 'Pre-Engineering',
  },
  {
    excel: `${PHASE5}/3 engineering and 8 computer science.xlsx`,
    photoDir: `${PHASE5}/3 engineering and 8 computer science`,
    photoPrefix: 'evening-students/fifth_phase_eveing/3 engineering and 8 computer science',
    className: 'auto',
  },
  {
    excel: `${PHASE5}/max.xlsx`,
    photoDir: `${PHASE5}/max pic`,
    photoPrefix: 'evening-students/fifth_phase_eveing/max pic',
    className: 'auto',
  },
];
...
function resolveClass(discipline, rollN, forced) {
  ...
  if (/cis|computer|c\.?\s*s/.test(d)) return 'Computer Science';
...
function writeDisciplineUrls(filePath, students) {
  ...
  let out = '# Phase 5 Student URLs — by Discipline (Morning / Evening)\n';
  out += `# Domain: ${DOMAIN}\n`;
...
const targets = [
  ...
  },
  {
    ...
    comment: 'Morning Shift — Pre-Medical 1st Year (2026-2028), including phase 4 + phase 5.',
  ...
  },
  {
    ...
    comment:
      'Evening Shift — Computer Science 1st Year (2026-2028), including phase 4 + phase 5.',
  ...
  },
  {
    ...
    comment: 'Evening Shift — Pre-Medical 1st Year (2026-2028), including phase 4 + phase 5.',
...
const outDir = path.join(root, PHASE5);
...
writeUrls(path.join(outDir, 'URLS-morning-phase5.txt'), morning, 'Phase 5 — Morning students');
writeUrls(path.join(outDir, 'URLS-evening-phase5.txt'), evening, 'Phase 5 — Evening students');
writeUrls(path.join(outDir, 'URLS-all-phase5.txt'), allNew, 'Phase 5 — All students (M+E)');
writeDisciplineUrls(path.join(outDir, 'URLS-by-discipline-phase5.txt'), allNew);
