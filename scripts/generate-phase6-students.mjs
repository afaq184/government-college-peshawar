/**
 * Phase 6 (evening-students/sixth_phase): CS, Pre-Engineering, Pre-Medical.
...
const PHASE6 = 'public/student/evening-students/sixth_phase';
...
const SOURCES = [
  {
    excel: `${PHASE6}/medical and cs.xlsx`,
    photoDir: `${PHASE6}/medical and computer science`,
    photoPrefix: 'evening-students/sixth_phase/medical and computer science',
    className: 'auto',
  },
  {
    excel: `${PHASE6}/engineering and computer science.xlsx`,
    photoDir: `${PHASE6}/engineering and computer science`,
    photoPrefix: 'evening-students/sixth_phase/engineering and computer science',
    className: 'auto',
  },
  {
    excel: `${PHASE6}/pre engineering evening 1.xlsx`,
    photoDir: `${PHASE6}/Pre engineering evening 1`,
    photoPrefix: 'evening-students/sixth_phase/Pre engineering evening 1',
    className: 'Pre-Engineering',
  },
  {
    excel: `${PHASE6}/pre engineering evening 2.xlsx`,
    photoDir: `${PHASE6}/Pre engineering evening_2`,
    photoPrefix: 'evening-students/sixth_phase/Pre engineering evening_2',
    className: 'Pre-Engineering',
  },
];
...
function writeDisciplineUrls(filePath, students) {
  ...
  let out = '# Phase 6 Student URLs — by Discipline (Morning / Evening)\n';
  out += `# Domain: ${DOMAIN}\n`;
...
const targets = [
  ...
  },
  {
    ...
    comment: 'Morning Shift — Pre-Medical 1st Year (2026-2028), including phase 4–6.',
  ...
  },
  {
    ...
    comment:
      'Evening Shift — Pre-Engineering 1st Year (2026-2028), including phase 4–6.',
  ...
  },
  {
    ...
    comment: 'Evening Shift — Pre-Medical 1st Year (2026-2028), including phase 4–6.',
...
const outDir = path.join(root, PHASE6);
...
writeUrls(path.join(outDir, 'URLS-morning-phase6.txt'), morning, 'Phase 6 — Morning students');
writeUrls(path.join(outDir, 'URLS-evening-phase6.txt'), evening, 'Phase 6 — Evening students');
writeUrls(path.join(outDir, 'URLS-all-phase6.txt'), allNew, 'Phase 6 — All students (M+E)');
writeDisciplineUrls(path.join(outDir, 'URLS-by-discipline-phase6.txt'), allNew);
